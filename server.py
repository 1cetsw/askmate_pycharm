...
def route_edit(question_id):
    # TODO check if POST is handled here
    table = data_handler.get_all_user_question(FILE)
    if request.method == 'GET':
        return render_template('update.html', result = data_handler.find_record(table, question_id))
...
def route_display_question(question_id):
    ...
    return render_template('question.html', result=data_handler.find_record(table, question_id))
